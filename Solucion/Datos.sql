...
INSERT INTO [dbo].[Gato]
     ...
     VALUES
        ...
        ('Snow', 'abisnio', 3, 2, '12321241241'),
        ('Oreo', 'turco', 3, 2, '123221412241'),
        ('Silver', 'Persa', 13, 2, '12321412412'),
        ('Teddy', 'Persa', 13, 2, '12321412412'),
        ('Tom', 'Persa', 13, 2, '12321412412'),
        ('Garfield', 'Persa', 13, 2, '12321412412'),
        ('Simba', 'Persa', 13, 2, '12321412412'),
        ('Charlie', 'Persa', 13, 2, '12321412412'),
        ('Boots', 'abisnio', 3, 2, '12321412412'),
        ('Piccolo', 'turco', 3, 2, '12321412412'),
        ('Apollo', 'Persa', 14, 2, '12321412412'),
        ('Bruno', 'turco', 3, 2, '12321412412'),
        ('Notte', 'birmano', 3, 2, '12321412412'),
        ('Pascal', 'turco', 3, 2, '12321412412'),
        ('Gaston', 'ruso', 3, 2, '12321412412'),
        ('Monet', 'abisnio', 3, 2, '12321412412'),
        ('Jules', 'bobtail', 3, 2, '12321412412'),
        ('Eiki', 'birmano', 3, 2, '12321412412'),
        ('Reiko', 'abisnio', 3, 2, '12321412412'),
        ('Akiro', 'bobtail', 3, 2, '12321412412'),
        ('Hikaru', 'abisnio', 3, 2, '12321412412'),
        ('Taki', 'bobtail', 3, 2, '12321412412'),
        ('Kenzo', 'birmano', 3, 2, '12321412412'),
        ('Kichiro', 'bobtail', 3, 2, '12321412412')
GO
